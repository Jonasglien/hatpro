...
export default function LoginPage() {
  return (
    <div className="p-8 flex flex-col gap-16 flex-grow">
...
function ResourceCard({
  ...
  return (
    <a
      ...
      className="flex flex-col gap-2 p-4 border-2 border-slate-200 dark:border-slate-800 rounded-md hover:bg-slate-100 dark:hover:bg-slate-900"
    >
